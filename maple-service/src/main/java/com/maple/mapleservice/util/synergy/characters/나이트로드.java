...
@Getter
public class 나이트로드 {
	String character_class = "나이트로드";
	Integer cycle = 3;
	List<String> skill_type = List.of("슬로우", "드롭률");
	List<SynergySkill> skill_desc = List.of(
		new SynergySkill(
			"퍼지 에어리어",
			"주위에 결계를 펼쳐 결계 안으로 들어오는 적들의 공격력과 이동속도, 방어율을 감소시킨다. "
				+ "추가로 영구히 보스 사냥 시 추가 데미지를 줄 수 있다",
			"MP 41 소비, 40초 동안 지속, 결계 안의 보스 몬스터를 제외한 적의 공격력 및 방어율 30% 감소, 이동속도 -60\n[패시브 효과 : 보스 몬스터 공격 시 데미지 10% 증가]",
			"https://open.api.nexon.com/static/maplestory/SkillIcon/KFPGKFPBNF.png"
		),
		new SynergySkill(
			"쇼다운 챌린지",
			...
			"MP 50, 표창 3개 소비 "
				+ "MP 50, 표창 3개 소비\n최대 6명의 적 708% 데미지로 2번 공격하고 6개의 수리검을 생성하며 도발\n도발당한 적은 부딪히지 않는 상태 지속. 140초 동안 획득 경험치, 아이템 드롭률 5% 증가, 보스일 경우 효과 절반\n수리검은 24% 데미지로 6번 공격을 하며 한 명의 적이 여러 개의 수리검에 맞을 경우 두 번째 수리검부터 최종 데미지 50% 감소, 일반 몬스터 공격 시 데미지 200% 증가n수리검 생성 후 재생성까지 대기시간 5초",
			"https://open.api.nexon.com/static/maplestory/SkillIcon/KFPGKFPBNH.png"
		)
	);
