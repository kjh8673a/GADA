...
public class UnionInfoResponseDto {
	...
	List<String> total_union_occupied_stat;
	...
	public static UnionInfoResponseDto of(int union_level, String union_grade, List<String> union_raider_stat,
		List<String> total_union_raider_stat, List<String> union_occupied_stat, List<String> total_union_occupied_stat,
		List<UnionBlock> union_block, List<UnionInnerStat> union_inner_stat) {
		return UnionInfoResponseDto.builder()
			...
			.total_union_occupied_stat(total_union_occupied_stat)
