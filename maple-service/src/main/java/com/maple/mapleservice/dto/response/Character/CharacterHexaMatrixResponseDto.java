...
public class CharacterHexaMatrixResponseDto {
	...
	HexaStatCore character_hexa_stat_core;

	public static CharacterHexaMatrixResponseDto of(List<HexaMatrix> character_hexa_core_equipment,
		Long used_sol_erda_energy, Long used_sol_erda_fragment, List<SkillDesc> character_skill_desc,
		HexaStatCore character_hexa_stat_core) {
		return CharacterHexaMatrixResponseDto.builder()
			...
			.character_hexa_stat_core(character_hexa_stat_core)
			.build();
	}
}
