      ...
      <BigContainer>
        <ClickBox onClick={searchCharacter}>
          ...
          <CharacterDescription>
            <div>서버 : {characterBasic.data?.world_name}</div>
            <div>직업 : {characterBasic.data?.character_class}</div>
            <div>레벨 : {characterBasic.data?.character_level}</div>
            <div>길드 : {characterBasic.data?.character_guild_name}</div>
            <div>전투력 : {convertCombatPower(characterBasic.data?.combat_power)}</div>
          </CharacterDescription>
        </ClickBox>
      </BigContainer>
    );
